...
addCapButton.click(function() {
  ...
  createImage('hat.png',{xStart: 50, yStart: 80,}, true);
  layer.draw();
});

addJointButton.click(function() {
  textParamsButton.toggleClass('hidden');
  createImage('joint.png',{xStart: 50, yStart: 80,}, true);
  layer.draw();
});

addSunGlasses.click(function() {
  textParamsButton.toggleClass('hidden');
  createImage('glasses.png',{xStart: 50, yStart: 80,}, true);
  layer.draw();
});

addThugLife.click(function() {
  textParamsButton.toggleClass('hidden');
  createImage('thug_life.png',{xStart: 50, yStart: 80,}, true);
  layer.draw();
});
